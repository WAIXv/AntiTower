...
public class CameraRover : ActionBase
{
    ...
    void Start()
    {
        ...
        {
            transform.position = new Vector3(23f, 917f, 2.5f);
            transform.eulerAngles = new Vector3(88f, 179f, 0f);
        }
    }
    ...
    IEnumerator SwitchScene_Main()
    {
        ...
        {
            transform.DOMove(new Vector3(11f, 290f, 582f), 2f);
            transform.DORotate(new Vector3(25f, -180f, 0f), 2f);
            yield return new WaitForSeconds(2f);
        }
        yield return new WaitForEndOfFrame();
